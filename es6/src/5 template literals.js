"use strict";
//1 make a template 
   let template = '<h1>Hello</h1><p>This is simple template of JS</p>';
...
let template2 = '<h1>Multi line</h1><p>'+
...
let name = 'JoHNdsklfk';
let template3= `<h1>${makeUpperCase("to upper case text")} Multi line ${name} </h1><p> This is MULTYPLAne template of JS</p>`;
//or use ` 
/*`<h1>Multi line</h1><p>'+
'This is MULTYPLAne template of JS</p>`;*/
